...
export const createAccount = async (req, res, next) => {
  ...
  try {
    ...
    let account_start_date = !!date && date !== '' ? date : new Date();
    ...
    account_start_date =
      account_type_name === 'pocket_saving' ? new Date() : account_start_date;
    ...
    if (accountTypeIdReq === 5) {
      ...
      return res.status(201).json({
        status: 201,
        data: { account_basic_data, category_budget_account },
        message,
      });
    }
    //--------------------
